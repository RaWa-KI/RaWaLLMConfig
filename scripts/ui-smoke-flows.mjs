...
async function openSettings(win, tab = 'tweaks') {
  // D5-Nav: Einstellungen ist ein Hauptbereich in der LlmBar (.sec-btn),
  // kein separater „Einstellungen öffnen"-Button mehr. Scoped + Retry gegen
  // den transienten Start-Overlay-Fall (waitForStartup in launch()).
  // Modus-Weiche (E-WP1/D2): .settings-tabs rendert nur im Experten-Modus —
