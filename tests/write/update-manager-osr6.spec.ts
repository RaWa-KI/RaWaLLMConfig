...
import { checkForUpdates, getUpdateState, resetUpdateCheckCacheForTest } from '../../src/main/services/update-manager'
...
test('source error keeps stale known status without claiming a fresh no-update result', async () => {
  ...
  // Fehlerpfad erzwingt einen frischen Check (TTL-Cache des Erfolgs-Checks umgehen).
  resetUpdateCheckCacheForTest()
