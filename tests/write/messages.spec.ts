...
test('no-param messages are returned unchanged', () => {
  ...
  expect(msg('update.toast.noPlatformAsset')).toBe('Für dieses System ist kein Update-Paket enthalten.')
  ...
  expect(msg('update.error.appimageEnvMissing')).toContain('AppImage-Ziel')
