...
const api: ElectronApi & WriteApi & UpdatesApi & ListDirApi & RefreshApi & GraphApi & CompareApi & ArchiveApi & SourcesApi & IntegrityApi & ConfigWatcherFsApi & DiagnosticsApi & { integrations: IntegrationsApi } = {
  ...read,
  ...write,
  ...updates,
  ...configWatcherFs,
